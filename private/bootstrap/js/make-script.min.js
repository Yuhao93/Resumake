...
!1;activityEdit.items=[]});$("#code-preview").click(function(){completeResume();$("#basic-resume").attr("value");$(this).attr("target","_blank");$.post("../resumepreview/index.php",{content:JSON.stringify(resume)},function(a){window.open().document.writeln(a)})});$("#code-submit").click(function(){completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/addResume.php",{uid:uid,resume:resume,name:a},function(){window.location.href="../users/"+username})})});
