...
function resetTimer(){void 0!=timerId&&clearTimeout(timerId);timerId=setTimeout("pushDraft()",5E3)}function pushDraft(){completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/draft.php",{request:"push",uid:uid,content:resume,name:a},function(){})}function clearDraft(){$.post("../private/php_scripts/draft.php",{request:"clear",uid:uid},function(){})};