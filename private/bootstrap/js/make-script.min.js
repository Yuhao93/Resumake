...
!1;activityEdit.items=[]});$("#code-preview").click(function(){completeResume()});$("#code-submit").click(function(){completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/addResume.php",{uid:uid,resume:resume,name:a},function(a){window.location.href="../users/"+username;window.open("http://resumake.thegbclub.com/rmks/"+username+"/"+a)})})});
