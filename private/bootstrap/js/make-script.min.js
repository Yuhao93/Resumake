...
function resetTimer(){void 0!=timerId&&clearTimeout(timerId);timerId=setTimeout("pushDraft()",5E3)}function pushDraft(){void 0!=timerId&&clearTimeout(timerId);completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/draft.php",{request:"push",uid:uid,content:JSON.stringify(resume),name:a},function(a){alert(a)})}function clearDraft(){$.post("../private/php_scripts/draft.php",{request:"clear",uid:uid},function(){})};