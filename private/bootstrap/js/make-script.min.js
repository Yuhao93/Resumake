...
$(document).ready(function(){$("input").focus(function(){pushDraft()});$("select").focus(function(){pushDraft()});$("#education-award-add").click(function(){addAward()});$("#education-save").click(function(){saveEducation();pushDraft()});$("#add-education-btn").click(function(){educationEdit.isEdit&&($("#skill-category").attr("value",""),$("#skill-list").html(""));educationEdit.isEdit=!1;educationEdit.awards=[]});$("#skill-add").click(function(){addSkill()});$("#skill-save").click(function(){saveSkillCategory();
pushDraft()});$("#add-skill-btn").click(function(){skillEdit.isEdit=!1;skillEdit.skills=[]});$("#experience-fact-add").click(function(){addDescExperience()});$("#experience-link-add").click(function(){addLinkExperience()});$("#experience-save").click(function(){saveExperienceCategory();pushDraft()});$("#btn-add-experience").click(function(){experienceEdit.isEdit=!1;experienceEdit.items=[]});$("#activity-fact-add").click(function(){addDescActivity()});$("#activity-link-add").click(function(){addLinkActivity()});
...
function pushDraft(){completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/draft.php",{request:"push",uid:uid,content:resume,name:a},function(){})}function clearDraft(){$.post("../private/php_scripts/draft.php",{request:"clear",uid:uid},function(){})};