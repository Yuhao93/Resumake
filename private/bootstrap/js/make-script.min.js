...
!1;activityEdit.items=[]});$("#code-preview").click(function(){completeResume();$("#basic-resume").attr("value");$("#hidden-content").attr("value",JSON.stringify(resume));$("#preview-form").submit()});$("#code-submit").click(function(){completeResume();var a=$("#basic-resume").attr("value");$.post("../private/php_scripts/addResume.php",{uid:uid,resume:resume,name:a},function(){window.location.href="../users/"+username})})});
