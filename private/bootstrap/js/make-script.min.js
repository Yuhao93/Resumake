...
function pushDraft(){completeResume();$.post("../private/php_scripts/draft.php",{request:"push",uid:uid,content:resume,name:name},function(){})}function clearDraft(){$.post("../private/php_scripts/draft.php",{request:"clear",uid:uid},function(){})};