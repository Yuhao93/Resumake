...
"</h3>",d=0;d<b.length;d++)"link"==b[d].type?c+='<a href="'+b[d].link+'" target="_blank">'+b[d].name+"</a><br>":"desc"==b[d].type&&(c+="<p><strong>"+b[d].desc+"</strong></p>");c+="</div>";$("#activity-container").append(c);$("#activity-edit-"+a).click(function(){var a=$(this).attr("id").substring(14);editActivity(a)});$("#activity-delete-"+a).click(function(){var a=$(this).attr("id").substring(16);resume.activityInfo.splice(a,1);revalidateActivityField()})}}
