...
function revalidateExperienceField(){$("#experience-container").html("");for(var a=0;a<resume.experienceInfo.length;a++){for(var b=resume.experienceInfo[a].endDate,c=resume.experienceInfo[a].items,b='<div class="experience-object" id = "experience-object-'+a+'"><a class="close" id="experience-delete-'+a+'">X</a><h3><a class="experience-edit-link" id="experience-edit-'+a+'" href="#experience-modal" data-toggle="modal">'+resume.experienceInfo[a].position+"</a></h3><h3>"+resume.experienceInfo[a].group+
" "+getFormattedDate(resume.experienceInfo[a].startDate)+" - "+getFormattedDate(b)+"</h3>",d=0;d<c.length;d++)"link"==c[d].type?b+='<a href="'+c[d].link+'" target="_blank">'+c[d].name+"</a>":"desc"==c[d].type&&(b+="<p><strong>"+c[d].desc+"</strong></p>");b+="</div>";$("#experience-container").append(b);$("#experience-edit-"+a).click(function(){var a=$(this).attr("id").substring(16);editExperience(a)});$("#experience-delete-"+a).click(function(){var a=$(this).attr("id").substring(18);resume.experienceInfo.splice(a,
1);revalidateExperienceField()})}}
...
function revalidateActivityField(){$("#activity-container").html("");for(var a=0;a<resume.activityInfo.length;a++){for(var b=resume.activityInfo[a].endDate,c=resume.activityInfo[a].items,b='<div class="activity-object" id = "activity-object-'+a+'"><a class="close" id="activity-delete-'+a+'">X</a><h3><a class="activity-edit-link" id="activity-edit-'+a+'" href="#activity-modal" data-toggle="modal">'+resume.activityInfo[a].position+"</a></h3><h3>"+resume.activityInfo[a].group+" "+getFormattedDate(resume.activityInfo[a].startDate)+
" - "+getFormattedDate(b)+"</h3>",d=0;d<c.length;d++)"link"==c[d].type?b+='<a href="'+c[d].link+'" target="_blank">'+c[d].name+"</a>":"desc"==c[d].type&&(b+="<p><strong>"+c[d].desc+"</strong></p>");b+="</div>";$("#activity-container").append(b);$("#activity-edit-"+a).click(function(){var a=$(this).attr("id").substring(16);editActivity(a)});$("#activity-delete-"+a).click(function(){var a=$(this).attr("id").substring(18);resume.activityInfo.splice(a,1);revalidateActivityField()})}}
...
!1;activityEdit.items=[]});$("#code-submit").click(function(){var a=editor.getValue(),b=$("#resume-name").attr("value");$.post("../private/php_scripts/addResume.php",{uid:uid,username:username,content:a,name:b},function(){window.location.href="../rmks/?uid="+uid})})});
