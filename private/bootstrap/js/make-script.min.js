...
function repopulateActivityItems(){$("#activity-item-list").html("");alert(activityEdit);for(var a=0;a<activityEdit.items.length;a++){var b=activityEdit.items[a],b="desc"==b.type?"<p><strong>"+b.desc+"</strong></p>":'<a href="'+b.link+'" target="_blank">'+b.name+"</a>";$("#activity-item-list").append('<li class="span3 activity-item" id="activity-'+a+'"><button class="close pull-right" id="activity-'+a+'">x</button>'+b+"</li>");$("button#activity-"+a).click(function(){var a=$(this).attr("id").substring(9);
$("li#activity-"+a).remove();activityEdit.items=[];$("li.activity-item").each(function(){var a=$(this).html(),b=a.replace(a.split("</button>")[0]+"</button>","");if(0==b.indexOf("<p><strong>"))a=b.substring(11,b.length-13),activityEdit.items.push({type:"desc",desc:a});else if(0==b.indexOf('<a href="')){var c=b.indexOf('" target="_blank">'),a=b.substring(c+18,b.length-4),b=b.substring(9,c);activityEdit.items.push({type:"link",name:a,link:b})}})})}}
