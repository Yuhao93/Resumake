		...
		<div class="modal hide" id="registermodal">
			...
			<div class="modal-body">
				<form class="well">
					...
					<input type="password" class="span5" placeholder="Password" name="password">
					
					<label>Confirm Password</label>
					<input type="password" class="span5" placeholder="Confirm Password" name="confirm">
