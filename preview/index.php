...
<body>
    ...
    <div class="row span12">
        <br><br><br><br><br><br>
        <center><h1 class="row span12">No Tricky Web Programming, No Hassle, Just That Simple</h1></center>
        <br><br><br><br><br>
    ...
    <div class="row span12">
        <br><br><br><br><br><br>
        <center><h1 class="row span12">Let Resumake Play Match-maker</h1></center>
        <br><br><br><br><br>
        <section class="span5">
            <div class="page-header">
