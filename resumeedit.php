...
<body>
    ...
    <div class="container">
		...
		<div class="row span12 well">
			...
			<input class="span3" type="text" placeholder="Resume Name" id="basic-resume" value="<?php echo $resume_name?>">
			<br>
			...
			<input class="span3" type="text" id="basic-position" value="<?php echo $resume_object['basicInfo']['position']?>" >
			<br>
